...
def test_face_restoration_controls_toggle(tk_root):
    ...
    assert visible_count >= 2, f"Expected at least 2 visible face restoration widgets, got {visible_count}"
    ...
    assert visible_count_after < visible_count, "Face restoration widgets should be hidden when disabled"
