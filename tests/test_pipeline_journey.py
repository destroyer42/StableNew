...
def mock_client():
    ...
    def txt2img_side_effect(payload):
        ...
        return {
            'images': [mock_image_b64] * batch_size,
            'parameters': {}
        }
    ...
    client.upscale_image.return_value = {
