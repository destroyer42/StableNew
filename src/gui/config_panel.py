...
class ConfigPanel(ttk.Frame):
    ...
    def _build_txt2img_tab(self):
        ...
        steps_spin = ttk.Spinbox(basic_frame, from_=1, to=150, textvariable=self.txt2img_vars['steps'], width=15)
        ...
        cfg_spin = ttk.Spinbox(basic_frame, from_=1.0, to=30.0, increment=0.5, textvariable=self.txt2img_vars['cfg_scale'], width=15)
        ...
        width_spin = ttk.Spinbox(dim_frame, from_=MIN_DIMENSION, to=MAX_DIMENSION, increment=64, textvariable=self.txt2img_vars['width'], width=15)
        ...
        height_spin = ttk.Spinbox(dim_frame, from_=MIN_DIMENSION, to=MAX_DIMENSION, increment=64, textvariable=self.txt2img_vars['height'], width=15)
        ...
        hires_steps_spin = ttk.Spinbox(hires_frame, from_=0, to=150, textvariable=self.txt2img_vars['hires_steps'], width=15)
        ...
        hr_scale_spin = ttk.Spinbox(hires_frame, from_=1.0, to=4.0, increment=0.1, textvariable=self.txt2img_vars['hr_scale'], width=15)
        ...
        denoise_spin = ttk.Spinbox(hires_frame, from_=0.0, to=1.0, increment=0.05, textvariable=self.txt2img_vars['denoising_strength'], width=15)
        ...
        face_weight_spin = ttk.Spinbox(face_frame, from_=0.0, to=1.0, increment=0.1, textvariable=self.txt2img_vars['face_restoration_weight'], width=15)
        ...
        clip_spin = ttk.Spinbox(advanced_frame, from_=1, to=12, textvariable=self.txt2img_vars['clip_skip'], width=15)
    ...
    def _build_img2img_tab(self):
        ...
        row = 0
        ttk.Label(basic_frame, text="Steps:").grid(row=row, column=0, sticky=tk.W, pady=2)
        steps_spin = ttk.Spinbox(basic_frame, from_=1, to=150, textvariable=self.img2img_vars['steps'], width=15)
        steps_spin.grid(row=row, column=1, sticky=tk.W, pady=2)
        self.img2img_widgets['steps'] = steps_spin
        row += 1
        
        ttk.Label(basic_frame, text="Denoising:").grid(row=row, column=0, sticky=tk.W, pady=2)
        denoise_spin = ttk.Spinbox(basic_frame, from_=0.0, to=1.0, increment=0.05, textvariable=self.img2img_vars['denoising_strength'], width=15)
        denoise_spin.grid(row=row, column=1, sticky=tk.W, pady=2)
        self.img2img_widgets['denoising_strength'] = denoise_spin
        row += 1
        
        ttk.Label(basic_frame, text="CFG Scale:").grid(row=row, column=0, sticky=tk.W, pady=2)
        cfg_spin = ttk.Spinbox(basic_frame, from_=1.0, to=30.0, increment=0.5, textvariable=self.img2img_vars['cfg_scale'], width=15)
        cfg_spin.grid(row=row, column=1, sticky=tk.W, pady=2)
        row += 1
    ...
    def _build_upscale_tab(self):
        ...
        scale_spin = ttk.Spinbox(settings_frame, from_=1, to=4, textvariable=self.upscale_vars['scale'], width=15)
    ...
    def _build_api_tab(self):
        ...
        timeout_spin = ttk.Spinbox(settings_frame, from_=10, to=300, textvariable=self.api_vars['timeout'], width=15)
