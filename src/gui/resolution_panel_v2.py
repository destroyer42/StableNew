...
class ResolutionPanelV2(ttk.Frame):
    ...
    def __init__(self, master: tk.Misc, *, theme: object = None, presets: dict[str, tuple[int, int]] | None = None) -> None:
        ...
        ttk.Label(row, text="Width", style=getattr(self.theme, "STATUS_LABEL_STYLE", theme_mod.STATUS_LABEL_STYLE)).pack(side=tk.LEFT)
        ...
        ttk.Label(row, text="Height", style=getattr(self.theme, "STATUS_LABEL_STYLE", theme_mod.STATUS_LABEL_STYLE)).pack(side=tk.LEFT)
        ...
        ttk.Label(preset_row, text="Preset", style=getattr(self.theme, "STATUS_LABEL_STYLE", theme_mod.STATUS_LABEL_STYLE)).pack(side=tk.LEFT)
        ...
        ttk.Label(preset_row, text="Ratio", style=getattr(self.theme, "STATUS_LABEL_STYLE", theme_mod.STATUS_LABEL_STYLE)).pack(side=tk.LEFT)
        ...
        ttk.Label(self, textvariable=self.mp_var, style=getattr(self.theme, "STATUS_LABEL_STYLE", theme_mod.STATUS_LABEL_STYLE)).pack(anchor=tk.W, pady=(theme_mod.PADDING_SM, 0))
